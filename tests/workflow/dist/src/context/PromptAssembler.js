...
class PromptAssembler {
    constructor() {
        this.workspaceIndexer = new WorkspaceIndexer_1.WorkspaceIndexer();
        this.editorContext = new EditorContext_1.EditorContext();
        this.diagnosticsEngine = new DiagnosticsEngine_1.DiagnosticsEngine();
    }
