...
class WorkflowLoop {
    constructor(processManager, eventRouter, promptAssembler, outputChannel) {
        ...
        this._onPhaseChange = new vscode.EventEmitter();
        this._onPlanReady = new vscode.EventEmitter();
        this._onExecutionComplete = new vscode.EventEmitter();
        this._onVerificationComplete = new vscode.EventEmitter();
        this._onError = new vscode.EventEmitter();
        this.onPhaseChange = this._onPhaseChange.event;
        this.onPlanReady = this._onPlanReady.event;
        this.onExecutionComplete = this._onExecutionComplete.event;
        this.onVerificationComplete = this._onVerificationComplete.event;
